# UI5 codecompletion
`ui5-codecompletion` is a node CLI that enables code completion in WebStorm's JS editor 
based on a specific version of [(open)UI5](https://openui5.org). 
...
## Usage
    ...
    Options:
      ...
      -t, --to         file system path, relative to $project_dir, to store UI5
                       sources in; defaults to "/Users/vbuzek/.ui5"
      -s, --sourceDir  file system path, relative to $project_dir, to configure code
                       completion with; defaults to "/Users/vbuzek/.ui5"
    ...
    Examples:
      ...
      --from=https://url/openui5-runtime.zip    to /Users/vbuzek/.ui5
      ui5-codecompletion install \              installs UI5 from the URL pointing
      > -f=https://url/openui5-runtime.zip \    to the .zip, to
      > -t=ui5/sources/local                    $project_dir/ui5/sources/local
      ui5-codecompletion configure              uses UI5 sources in
                                                /Users/vbuzek/.ui5 to configure code
                                                completion
      ui5-codecompletion configure              uses UI5 sources in
      --sourceDir=my/relative/dir/ui5           $project_dir/my/relative/dir/ui5 to
